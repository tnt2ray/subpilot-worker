...
| sing-box 字段宽松透传 | 增加固定版本校验 | 官方 1.15.0-alpha.6 Schema 检查字段，图检查负责实际引用与循环 |
...
按仓库规则使用类型检查、Worker 构建、公开文件扫描、浏览器实际操作与本地 API 请求，不新增或修改测试代码。官方 sing-box 1.15.0-alpha.6 检查完整输出与编译规则源。GitHub 发布、远程 Secrets/KV 修改及线上部署均不属于本次实现验证。
