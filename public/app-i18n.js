export const I18N = {
  ...
  surgeTailscaleSecretNotice: "Auth Key 会写入生成的 Surge 配置。请使用短期、预授权且权限受限的密钥，并保护管理令牌和订阅链接。",
  ...
  surgeTailscaleValidationError: "Tailscale 节点配置无效：策略名称和配置段名称必填且必须唯一；已启用节点还必须填写 Auth Key；配置段名称不能包含空格或配置分隔符。",
  surgeRules: "Surge 规则",
  ports: "端口",
